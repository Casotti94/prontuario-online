...
function Home() {
  ...
  const inputEvolucao = useRef();  // Altere de 'evolution' para 'evolucao'
  ...
  async function createUsers() {
    try {
      await api.post('/usuarios', {
        ...
        evolucao: inputEvolucao.current.value // Atualizado para 'evolucao'
      });
  ...
  function handleEdit(user) {
    ...
    inputEvolucao.current.value = user.evolucao;  // Atualizado para 'evolucao'
  }
      ...
      {users.map(user => (
        <div key={user.id} className='card'>
          <div>
            ...
            <p>Evolução: <span>{user.evolucao}</span></p> {/* Atualizado para 'evolucao' */}
          </div>
          <div>
